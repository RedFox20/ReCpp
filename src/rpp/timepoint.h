#pragma once
/**
 * High performance Duration/TimePoint, Copyright (c) 2016-2025, Jorma Rebane
...
// A separate utility for C-only code paths -- it just grabs a high accuracy TimePoint and converts it t
#if __cplusplus
extern "C" {
#endif
    /**
     * A separate utility for C-only code paths -- grabs a high accuracy TimePoint
     * and converts it to fractional seconds as a double.
