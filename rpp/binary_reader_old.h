 ...
 *     void undo(uint n);
 */
template<class read_impl> struct binary_reader_old final : public reader_base, public read_impl
{
    ...
    template<class Char> binary_reader_old& read(std::basic_string<Char>& str) noexcept {
    ...
    template<class Char> binary_reader_old& peek(std::basic_string<Char>& str) noexcept {
        int n = min<int>(read_int(), read_impl::available());
        str.resize(n);
...
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, strview& v)      noexcept { r.peek(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, std::string& v)  noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, std::wstring& v) noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, bool& v)   noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, char& v)   noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, byte& v)   noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, short& v)  noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, ushort& v) noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, int& v)    noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, uint& v)   noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, int64& v)  noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, uint64& v) noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, float& v)  noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, double& v) noexcept { r.read(v); return r; }
template<class C, class T, class U> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, std::vector<T, U>& v) noexcept { r.read(v); return r; }
template<class C> binary_reader_old<C>& operator>>(binary_reader_old<C>& r, binary_reader_old<C>& m(binary_reader_old<C>&)) noexcept { return m(r); }
...
template<uint SIZE = 512> using array_reader = binary_reader_old<array_read<SIZE>>;
/** @brief Reads data from an array view. Array size depends on its initialized view size. */
using view_reader = binary_reader_old<view_read>;
/** @brief Reads data from a dynamic buffer, possibly after a FILE read has been buffered. */
using buffer_reader = binary_reader_old<buffer_read>;
/** @brief Reads data from file using C FILE* API. */
using file_reader = binary_reader_old<file_read>;
/** @brief Reads data directly from an rpp::socket */
using socket_reader = binary_reader_old<socket_read>;
/**
...
template<class buffer, class storage> 
    using stream_reader = binary_reader_old<composite_read<buffer, storage>>;
