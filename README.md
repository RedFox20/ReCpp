...
Drive a top-level task to completion with [`event_loop::run_until_done(task<T>&)`](src/rpp/event_loop.h#L482) or [`run_until_done(deferred<T>&)`](src/rpp/event_loop.h#L511).
